...
"""
def getOneIp(proxys_list):
    # 初始化正则表达式
    lose_time, waste_time = initpattern()
    # 获取IP代理。如果代理池为空，那么更新 ip代理池
    ...
    ipString=split_proxy[0]+"://"+split_proxy[1] + ':' + split_proxy[2]
    return proxys_list,ipString

if __name__ == '__main__':
    proxysPool, ipString=getOneIp([])
    print(proxysPool)
    print(ipString)
